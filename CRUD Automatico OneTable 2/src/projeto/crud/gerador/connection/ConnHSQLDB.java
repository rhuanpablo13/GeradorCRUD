...
public class ConnHSQLDB extends GeradorConnection{


	public ConnHSQLDB(Banco banco) {
		super(banco);
		classeArquivo = carregarArquivo(Const.ARQUIVO_CONN_HSQLDB, Const.DIR_PADRAO_CONEXAO);
		buildClass();
	}
